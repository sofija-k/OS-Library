...
/* Define and functions for checking memory usage */
#define malloc malloc_csc369
#define free free_csc369
#define calloc(n,s) malloc(n*s)

extern void *malloc_csc369(size_t size);
extern void *free_csc369(void *ptr);
